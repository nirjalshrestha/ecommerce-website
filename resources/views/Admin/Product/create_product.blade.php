        ...
        <div class="box-body">
            ...
            <!-- text input -->
                ...
                <div class="form-group">
                    ...
                    <input type="integer" class="form-control" name="description" placeholder="Enter ...">
                </div>
                <div class="form-group">
                    <label>Detail</label>
                    <input type="integer" class="form-control" name="detail" placeholder="Enter ...">
                </div>
                <div class="form-group">
                    <label>Status</label>
                ...
                <div class="form-group">
                    <label>Price</label>
                    <input type="integer" class="form-control" name="price" placeholder="Enter ...">
                </div>
                <div class="form-group">
                    <label>Quantity</label>
                    <input type="integer" class="form-control" name="quantity" placeholder="Enter ...">
                </div>
